...
#define TMP_TIMEOUT_ALARMA 600000
...
int indice = 0;
void (*verificar_sensor[2])() = {verificar_estado_sensor_boton, verificar_estado_sensor_accelerometro};
...
void sonar_alerta()
{
    ...
    {
        int duracion = 1000 / duraciones[nota_actual] * 0.8; // Calcula la duración de la nota

        if (!alerta_sonando)
        {
            tone(actuador_buzzer.pin, melodia[nota_actual], duracion); // Inicia la nueva nota con duración
        ...
        else
        {
            ...
            {                                // Si ha pasado el tiempo de duración de la nota
                noTone(actuador_buzzer.pin); // Detén el tono actual
